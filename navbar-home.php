<header role="banner">
    <nav
        ...
        <div class="hidden lg:flex lg:gap-x-12 uppercase">
            <a href="/<?= $lang ?>/index" class="text-sm/6 text-white" aria-current="page">Home</a>
        ...
        <div class="hidden lg:flex rounded-full" aria-label="Selettore lingua">
            ...
            <button type="button" class="<?php echo ($lang == 'en') ? 'bg-white text-black' : 'text-white'; ?> py-1 px-3 font-semibold rounded-md cursor-pointer" onclick="setLang('en')" id="en" aria-pressed="<?= $lang == 'en' ? 'true' : 'false' ?>">EN</button>
        </div>
